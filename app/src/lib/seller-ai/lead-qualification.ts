...
const signals: Array<{ reason: string; points: number; pattern: RegExp }> = [
  ...
  { reason: "intención de compra", points: 35, pattern: /\b(quiero comprar|comprarlo|comprarla|lo quiero|cómo compro|como compro|me interesa|lo llevo|hacer pedido|quiero pedir)\b/i },
  { reason: "hablar con un asesor", points: 35, pattern: /\b(hablar con alguien|hablar con un asesor|whatsapp|hablemos)\b/i },
];

const explicitPurchaseIntent = /\b(quiero comprar|comprarlo|comprarla|lo quiero|cómo compro|como compro|cómo pago|como pago|quiero pagar|lo llevo|hacer pedido|quiero pedir|hablar con alguien|hablar con un asesor|continuar por whatsapp|hablemos por whatsapp)\b/i;
