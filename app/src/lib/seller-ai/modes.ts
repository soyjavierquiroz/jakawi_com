...
const closingIntentPattern = /\b(quiero comprar|me interesa comprar|quiero pedir|quiero pagar|quiero reservar|lo compro|lo quiero|lo quiero comprar|comprarlo|comprarla|como compro|cómo compro|pásame para comprar|pasame para comprar|quiero continuar por whatsapp|continuar por whatsapp|consultar por whatsapp|enviar consulta por whatsapp|dejar consulta por whatsapp|reservar|pagar|lo llevo)\b/i;
